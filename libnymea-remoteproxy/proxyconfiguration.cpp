...
QDebug operator<<(QDebug debug, ProxyConfiguration *configuration)
{
    ...
    debug.nospace() << Qt::endl << "========== ProxyConfiguration ==========" << Qt::endl;
    debug.nospace() << "Configuration file:" << configuration->fileName() << Qt::endl;
    debug.nospace() << "RemoteProxy configuration" << Qt::endl;
    debug.nospace() << "  - Server name:" << configuration->serverName() << Qt::endl;
    debug.nospace() << "  - Write logfile:" << configuration->writeLogFile() << Qt::endl;
    debug.nospace() << "  - Logfile:" << configuration->logFileName() << Qt::endl;
    debug.nospace() << "  - Log engine enabled:" << configuration->logEngineEnabled() << Qt::endl;
    debug.nospace() << "  - JSON RPC timeout:" << configuration->jsonRpcTimeout() << " [ms]" << Qt::endl;
    debug.nospace() << "  - Inactive timeout:" << configuration->inactiveTimeout() << " [ms]" << Qt::endl;
    debug.nospace() << "SSL configuration" << Qt::endl;
    debug.nospace() << "  - Enabled:" << configuration->sslEnabled() << Qt::endl;
    debug.nospace() << "  - Certificate:" << configuration->sslCertificateFileName() << Qt::endl;
    debug.nospace() << "  - Certificate key:" << configuration->sslCertificateKeyFileName() << Qt::endl;
    debug.nospace() << "  - Certificate chain:" << configuration->sslCertificateChainFileName() << Qt::endl;
    debug.nospace() << "  - SSL certificate information:" << Qt::endl;
    debug.nospace() << "      Common name:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::CommonName) << Qt::endl;
    debug.nospace() << "      Organisation:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::Organization) << Qt::endl;
    debug.nospace() << "      Organisation unit name:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::OrganizationalUnitName) << Qt::endl;
    debug.nospace() << "      Country name:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::CountryName) << Qt::endl;
    debug.nospace() << "      Locality name:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::LocalityName) << Qt::endl;
    debug.nospace() << "      State/Province:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::StateOrProvinceName) << Qt::endl;
    debug.nospace() << "      Email address:" << configuration->sslConfiguration().localCertificate().subjectInfo(QSslCertificate::EmailAddress) << Qt::endl;
    debug.nospace() << "  - SSL certificate issuer information:" << Qt::endl;
    debug.nospace() << "      Common name:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::CommonName) << Qt::endl;
    debug.nospace() << "      Organisation:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::Organization) << Qt::endl;
    debug.nospace() << "      Organisation unit name:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::OrganizationalUnitName) << Qt::endl;
    debug.nospace() << "      Country name:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::CountryName) << Qt::endl;
    debug.nospace() << "      Locality name:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::LocalityName) << Qt::endl;
    debug.nospace() << "      State/Province:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::StateOrProvinceName) << Qt::endl;
    debug.nospace() << "      Email address:" << configuration->sslConfiguration().localCertificate().issuerInfo(QSslCertificate::EmailAddress) << Qt::endl;
    debug.nospace() << "UnixSocketServer Proxy" << Qt::endl;
    debug.nospace() << "  - Filename:" << configuration->unixSocketFileName() << Qt::endl;
    debug.nospace() << "WebSocketServer TunnelProxy" << Qt::endl;
    debug.nospace() << "  - Host:" << configuration->webSocketServerTunnelProxyHost().toString() << Qt::endl;
    debug.nospace() << "  - Port:" << configuration->webSocketServerTunnelProxyPort() << Qt::endl;
    debug.nospace() << "TcpServer TunnelProxy" << Qt::endl;
    debug.nospace() << "  - Host:" << configuration->tcpServerTunnelProxyHost().toString() << Qt::endl;
    debug.nospace() << "  - Port:" << configuration->tcpServerTunnelProxyPort() << Qt::endl;
